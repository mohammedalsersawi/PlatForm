    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active">الادمن</li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        @foreach ($admins as $item)
                            ...
                            <tr>
                                ...
                                <td>{{ $item->name }}</td>
                                <td>{{ $item->email }}</td>
                                <td class="badge badge-danger">{{ $item->nametype }}</td>
                                <td>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ route('alladmin.update', 'test') }}" method="POST">
                                                    @csrf
                                                    @method('put')
                                                    <div class="row">
                                    ...
                                    <div class="modal fade" id="delete{{ $item->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('alladmin.destroy', 'test') }}"
                                                        method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{ route('alladmin.store') }}" method="POST">
                    @csrf
